...
const CakeCuttingButton: React.FC<CakeCuttingButtonProps> = ({ onCakeCutting }) => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-yellow-100 via-orange-50 to-pink-100 flex items-center justify-center px-4">
      <div className="text-center">
        <div className="mb-8">
          <h2 className="text-4xl md:text-6xl font-bold text-orange-600 mb-4" style={{ fontFamily: 'Georgia, serif' }}>
        ...
        <button
          ...
          className="group relative bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 text-white px-12 py-6 rounded-full text-2xl font-bold shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 overflow-hidden"
        >
          ...
          <div className="relative flex items-center space-x-3">
            ...
            <span>Let's Cut the Cake Together! 🎉</span>
          </div>
        ...
        <div className="mt-8 text-lg text-orange-600">
