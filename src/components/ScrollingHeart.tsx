  ...
  return (
    <div className="relative h-screen flex items-center justify-center bg-gradient-to-br from-red-100 via-pink-50 to-rose-100">
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 text-center">
        <p className="text-2xl md:text-3xl font-medium text-pink-600 mb-4" style={{ fontFamily: 'Georgia, serif' }}>
          My heart grows bigger for you every day
        </p>
        <p className="text-lg text-pink-500">Just like this heart grows as you scroll 💕</p>
      </div>
    </div>
  );
};
